...
###################################################
setwd("~/Big_Data_Course_Folder/LAB07")
...
###################################################
# Step 5: Converting variables to factors
###################################################
...
###################################################
#Step 6: Build and Review the Logistic Regression Model
###################################################
...
###################################################
#Step 7: Variable selection using stepwise regression
###################################################
## The Intercept Model
...
###################################################
#Step 9: Use relevel Function to re-level the Price
...
###################################################
#Step 11: Predict Outcome for a Sequence of MonthlyCharges Values 
