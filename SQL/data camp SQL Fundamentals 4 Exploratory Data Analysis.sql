...
--dates and times are stored in ISO 8601 format - YYYY-MM-DD hh:mm:ss
...
--how many requests in each of the 12 months during 2016-2017
...
--most common hour that requests are created
...
SELECT date_part('hour',date_created) AS hour,
 ...
 --finding out the day of the week and seeing if request time varies from
 --when it was created
...
SELECT to_char(date_created, 'day') AS day,
 ...
 --using date_trunc and a subquery to count the number of requests created per
 --day
...
-- Subquery to select maximum gap from request_gaps
 ...
 --EVALUATING WHY THE AVERAGE DAY TO RESOLVE IS 64 DAYS IN DATE SET
...
-- Group and order by the variable of interest
 ...
 --compute average completion time, filtering oout top 5% outliers
 SELECT category,
